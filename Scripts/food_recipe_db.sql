...
delete from recipe
where recipeid = '148c1a1e-a29e-4fd1-96c5-5d2782fd74d9'; 
...
as $forloopfunc$
	...
	begin 
		for i in start_numb..end_numb + 1 by incremented_by loop j := j + incremented_by;
		end loop;
		return j;
	end;
$forloopfunc$;
...
begin 
	foreach element_numb in array arr loop 
...
create or replace procedure insertion_and_retrieval(
	userunique_name uuid, 
	recipe_name varchar
) 
language plpgsql 
as $insert$
